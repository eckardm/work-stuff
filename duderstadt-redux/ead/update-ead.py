...
def make_c01_subgroup(unittitle_text, scopecontent_p_text):
    ...
    p.text = scopecontent_p_text 
    
    return c01

def make_c02_series(unittitle_text, unitdate_text, extent_text, physfacet_text, scopecontent_p1_text, scopecontent_p2_text):
    ...
    if physfacet_text:
        physfacet = etree.SubElement(physdesc, "extent")
        physfacet.attrib["altrender"] = "carrier"
        physfacet.text = physfacet_text 
    
    if scopecontent_p2_text:
        scopecontent = etree.SubElement(c02, "scopecontent")
        scopecontent_p1 = etree.SubElement(scopecontent, "p")
        scopecontent_p1.text = scopecontent_p1_text
...
def make_c03_subseries(unittitle_text, unitdate_text, extent_text, scopecontent_p1_text, scopecontent_p2_text):
    c03 = etree.Element("c03")
    c03.attrib["level"] = "subseries"
...
for unittitle_text, unitdate_text, extent_text, scopecontent_p1_text, scopecontent_p2_text in university_of_michigan_presidency:
    new_university_of_michigan_presidency = make_c03_subseries(unittitle_text, unitdate_text, extent_text, scopecontent_p1_text, scopecontent_p2_text)
...
def make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool):
    c04 = etree.Element("c04")
    c04.attrib["level"] = "otherlevel"
    c04.attrib["otherlevel"] = "sub-subseries"
...
for unittitle_text, extent_text, accessrestrict_bool in speeches:
    new_speeches = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)
...
for unittitle_text, extent_text, accessrestrict_bool in idea_files:
    new_idea_files = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)

    c02 = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[2]")[0]
    c02.append(new_idea_files)

new_strategy = make_c04_subsubseries("1986-1997 Strategy", "63 files", True)
...
for unittitle_text, extent_text, accessrestrict_bool in position_papers:
    new_position_papers = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)
...
for unittitle_text, extent_text, accessrestrict_bool in presentations:
    new_presentations = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)
...
for unittitle_text, extent_text, accessrestrict_bool in write_files:
    new_write_files = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)

    c02 = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[6]")[0]
    c02.append(new_write_files)

new_legacy = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)

c02 = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[7]")[0]
c02.append(new_legacy)

new_digital_images = make_c04_subsubseries(unittitle_text, extent_text, accessrestrict_bool)
...
def make_file(unittitle_text, unitdate_text, physfacet_text, dao_href_attrib, accessrestrict_bool):
    ...
    physloc.text = "Online"
    if unittitle_text.startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997"):
        unittitle_text = " - ".join(unittitle_text.split(" - ")[4:])
    unittitle = etree.SubElement(did, "unittitle")
    ...
    unitdate.attrib["type"] = "inclusive"
    if "/" in unitdate_text:
        normal = unitdate_text.split("/")[2]
        if len(unitdate_text.split("/")[0]) == 1:
            normal += "-0" + unitdate_text.split("/")[0]
        else:
            normal += "-" + unitdate_text.split("/")[0]
        if len(unitdate_text.split("/")[1]) == 1:
            normal += "-0" + unitdate_text.split("/")[1]
        else:
            normal += "-" + unitdate_text.split("/")[1]
        unitdate.attrib["normal"] = normal
    else:
        unitdate.attrib["normal"] = unitdate_text
    ...
    if accessrestrict_bool == True:
        accessrestrict = etree.SubElement(c0x, "accessrestrict")
        accessrestrict_p = etree.SubElement(accessrestrict, "p")
        accessrestrict_p.text = "ER RESTRICTED until "
        date = etree.SubElement(accessrestrict_p, "date")
        date.attrib["type"] = "restriction"
...
for sorted_metadatum in sorted_metadata:
    ...
    if sorted_metadatum["accessrestrict"]:
    ...
    elif sorted_metadatum["unittitle"].startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997" + " - " + "Position Papers" + " - " + "1991-1997 Position Papers"):
        c0x = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[4]/c04[2]")[0]
    
    elif sorted_metadatum["unittitle"].startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997" + " - " + "Presentations" + " - " + "1987-1995 Presentations"):
        c0x = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[5]/c04[1]")[0]
    
    elif sorted_metadatum["unittitle"].startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997" + " - " + "Write Files" + " - " + "1988 and earlier Write Files"):
    ...
    elif sorted_metadatum["unittitle"].startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997" + " - " + "Legacy Documents" + " - " + "Legacy Documents, circa 1996"):
        c0x = tree.xpath("/ead/archdesc[1]/dsc[1]/c01[2]/c02[1]/c03[7]/c04[1]")[0]
    
    elif sorted_metadatum["unittitle"].startswith("Digital Documents" + " - " + "University of Michigan Presidency, 1986-1997" + " - " + "Digital Images" + " - " + "Digital Images, circa 1996"):
...
with open("duderst-updated.xml", mode="w") as f:
    f.write(ead_text)
