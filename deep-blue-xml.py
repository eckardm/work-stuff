		...
		for row_dict in reader:
			if row_dict["CollItemNo"]:
				audio_item = E.audio_item(
					...
					E("dc.type", str(coll_item_nos_and_audio_genres[row_dict["CollItemNo"]]).replace('[', '').replace(']', '').replace("'", '').replace(',', ';')), # need to account for other rows
				...
				# jpegs
				for jpeg in coll_item_nos_and_jpegs[row_dict["CollItemNo"]]:
					audio_item.append(
						E.bitstream(
