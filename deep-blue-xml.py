				...
				for dig_file_calc in coll_item_nos_and_dig_file_calcs[row_dict["CollItemNo"]]:
					...
					if dig_file_calc.split('-')[0] in programs:
						if len(digital_file_components) == 6:
							bracket_info = "[Program " + dig_file_calc.split('-')[3] + "] : [Part " + dig_file_calc.split('-')[4] + "] : [Segment " + dig_file_calc.split('-')[5] + "] : "
						elif len(digital_file_components) == 5:
							bracket_info = "[Program " + dig_file_calc.split('-')[3] + "] : [Part " + dig_file_calc.split('-')[4] + "] : "
					else:
						if len(digital_file_components) == 5:
							bracket_info = "[Part " + dig_file_calc.split('-')[3] + "] : [Segment " + dig_file_calc.split('-')[4] + "] : "
						elif len(digital_file_components) == 4:
							bracket_info = "[Part " + dig_file_calc.split('-')[3] + "] : "
