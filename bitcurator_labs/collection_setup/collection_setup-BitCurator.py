...
if len(os.listdir(os.path.join(os.sep, "home", "bcadmin", "Pictures", "Logitech Webcam"))) == 0:
...
if os.path.isdir(os.path.join(os.sep, "home", "bcadmin", "Desktop", "Shared Folders and Media", "sf_Collections_Processing", collno + "-" + collname)) is False:
    os.mkdir(os.path.join(os.sep, "home", "bcadmin", "Desktop", "Shared Folders and Media", "sf_Collections_Processing", collno + "-" + collname))
